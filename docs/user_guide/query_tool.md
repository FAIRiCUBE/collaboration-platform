...
The interactive [Query Tool](https://fairicube-kb.epsilon-italia.it/) allows both experts and non-experts to easily discover and analyse the FAIRiCUBE data analysis and processing resources (pipelines, pre-processing, ML models and algorithms …).
